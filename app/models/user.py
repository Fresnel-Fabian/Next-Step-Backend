...
class User(Base):
    ...
    hashed_password: Mapped[str | None] = mapped_column(
        String(255), nullable=True  # Optional: Google users don't need this
    )
    ...
    avatar: Mapped[str | None] = mapped_column(
        String(512), nullable=True  # URLs can be long
    )
    ...
    created_at: Mapped[datetime] = mapped_column(
        DateTime, server_default=func.now()  # PostgreSQL sets this automatically
    )
